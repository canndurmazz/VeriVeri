...
namespace VeriTabanıProje
{
    public partial class siparis : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'fabrikavtDataSet4.Urun' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.urunTableAdapter1.Fill(this.fabrikavtDataSet4.Urun);
            baglanti.Open();
