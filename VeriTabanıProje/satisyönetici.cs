...
namespace VeriTabanıProje
{
    public partial class satisyönetici : Form
    {
        ...
        private void satisyönetici_Load(object sender, EventArgs e)
        {
            ...
            // TODO: Bu kod satırı 'fabrikavtDataSet14.Urun' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.urunTableAdapter.Fill(this.fabrikavtDataSet14.Urun);
            // TODO: Bu kod satırı 'fabrikavtDataSet13.Adres' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.adresTableAdapter.Fill(this.fabrikavtDataSet13.Adres);
            // TODO: Bu kod satırı 'fabrikavtDataSet12.Musteri' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.musteriTableAdapter.Fill(this.fabrikavtDataSet12.Musteri);
